      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-16 max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-2 group-hover:text-[#f180a9] transition-colors">Lista de Caninas</h3>
              <p className="text-gray-600 text-sm leading-relaxed">
                Visualiza y gestiona el registro completo de todas las caninas en el sistema
              </p>
            </div>
          </Link>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                Solicita la incorporación de nuevas caninas al sistema 
              </p>
            </div>
          </Link>
        </div>
        ...
        <div className="text-center pt-12 border-t border-gray-200">
          <p className="text-gray-500 text-sm font-mono">
            &gt; Sistema de Gestión de Caninas v1.0.0
          </p>
        </div>
      </div>
    </div>
